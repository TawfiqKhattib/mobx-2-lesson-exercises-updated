...
export class RestaurantStore {
    ...
    get restPopulation() {
        ...
        let counter = 0
        this.reservations.forEach(r => r.seated ? counter +=parseInt(r.numPeople): null)
        return (counter)
    }
    get completedTables() {
    ...
    seatRes = (id) => {
        ...
        let indx = this.reservations.findIndex(reserv => reserv.id===id);
        this.reservations[indx].seated=true;
    }
    completeRes = (id) => {
        ...
        let indx = this.reservations.findIndex(reserv => id===reserv.id);
        this.reservations[indx].completed=true;
    }
}